...
import DesktopSidebarMyStore from "components/userProfile/DesktopSidebarMyStore";
...
export default function MyStoreLayout({ children }: { children: React.ReactNode }) {
    ...
    useEffect(() => {
        if (router?.pathname === '/my-store/add-product') {
                ...
                <div className="container mx-auto p-0 md:p-0 md:px-0 flex rounded-lg  w-[1200px]">
                    {
                        ...
                        <div className="h-[625px] ">
                            <DesktopSidebarMyStore />
                        </div>
                    }
                    <main
                        className={
                            `container mx-auto ${!hiddenSideBar && 'ml-[-10px]'}`
                        }
                    >
                        <div className={
                            ` pt-4 pl-6`
