...
const Login = () => {
    ...
    const [navigating, setNavigating] = useState(false); // prevent multiple navigations
    ...
    const formatPhoneForDisplay = (raw: string): string => {
        ...
        else if (digits.startsWith('+62')) digits = digits.slice(3);
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        if (!isEmail) {
            ...
            setEmail(displayFormat);
        }

        try {
            const formData = new FormData();
            formData.append('email', rawToSend);
            ...
            <CardContainer>
                <CardAuth>
                    ...
                    <ContentCard>
                        ...
                        <ForgetPassword>
                            <p onClick={() => handleNavigate('/auth/reset')} style={{ cursor: 'pointer' }}>
                                Lupa Password
                            </p>
                        </ForgetPassword>
                        ...
                        <TextFooter>
                            Baru di Zukses?{' '}
                            <span onClick={() => handleNavigate('/auth/register')}>
                                Daftar
                            </span>
                        </TextFooter>
                    </ContentCard>
