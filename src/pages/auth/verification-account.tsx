...
const VerificationAccount = () => {
    ...
    const { type, email, whatsapp } = router.query;
    ...
    return (
        <AuthLayout>
            <Header style={{ padding: "0px" }}>
                <IconHeader src='/icon/arrow-left.svg' width={30} style={{ cursor: "pointer" }} />
            </Header>
            <VerificationContainer>
                <div>
                    ...
                    <Terms>
                        {!counter
                            ? <span style={{ color: theme.colors.primary, cursor: 'pointer' }}>Kirim ulang</span>
