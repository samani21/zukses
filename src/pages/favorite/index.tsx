                ...
                <div className="space-y-4 mt-8">
                    {stores.map(store => (
                        <div key={store.id} className="bg-white rounded-[5px] shadow-[1px_1px_10px_rgba(0,0,0,0.08)] border border-[#DCDCDC] overflow-hidden">
                            ...
                            <div className='border border-[#DDDDDD] flex justify-end items-start p-6 gap-4'>
                                <p className='text-[#333333] text-[16px] font-bold'>Total</p>
                                <div className='space-y-2'>
                                    <p className='text-[#E75864] font-bold text-[25px]'>
                                        {formatCurrency(cartSummary.totalPrice)}
                                    </p>
                                    <p className='text-[#333333] text-[16px]'>
                                        Hemat {formatCurrency(cartSummary.totalSavings)}
                                    </p>
                                </div>
                                <button className='bg-[#F6E9F0] px-4 py-2 border border-[#563D7C80]/50 flex items-center text-[#563D7C] text-[16px] font-semibold gap-2'>
                                    <img src="/icon/shopping-cart.svg" width={22} />
                                    Masukkan Keranjang
                                </button>
                                <button className='bg-[#DE4A53] px-4 py-2 text-white border border-[#563D7C80]/50 flex items-center text-[#563D7C] text-[16px] font-semibold gap-2'>
                                    Beli Sekarang
                                </button>
                            </div>
                        </div>
