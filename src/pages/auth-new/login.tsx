...
const LoginPage: NextPage = () => {
    return (
        <AuthNewLayout>
            <div className="w-[419px] max-w-md bg-white rounded-lg p-8" style={{ boxShadow: "1px 1px 11px rgba(0, 0, 0, 0.1)" }}>
                ...
                <form className="mt-4 space-y-4">
                    ...
                    <div>
                        ...
                        />
                        <p className="text-[12px] text-[#555555] font-bold ml-4 mt-1">
                            Lupa PIN?
                        </p>
                    </div>
