                ...
                <CardAuth>
                    <HeadCard>
                        ...
                        <RightHeaderCard>
                            ...
                            <Rectangle />
                            <SwitchLogo src='/icon-old/qr-code.svg' />
                        </RightHeaderCard>
                    </HeadCard>
                    <ContentCard>
                        ...
                        <ForgetPassword>
                            <p onClick={() => router.push('/auth-old/reset')} style={{ cursor: "pointer" }}>
                                Lupa Password
                            </p>
                        </ForgetPassword>
                        ...
                        <AuthWith>
                            <Facebook>
                                <IconSocial src='/icon-old/facebook.svg' width={20} />
                                Facebook
                            </Facebook>
                            <Google onClick={handleLoginGoogle}>
                                <IconSocial src='/icon-old/google.svg' width={30} />
                                Google
                            </Google>
                        </AuthWith>

                        <TextFooter>
                            Baru di Zukses? <span onClick={() => router.push('/auth-old/register')}>Daftar</span>
                        </TextFooter>
                    </ContentCard>
                </CardAuth>
            </CardContainer>
