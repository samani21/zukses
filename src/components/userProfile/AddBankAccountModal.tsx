            ...
            <div className="bg-white rounded-lg shadow-xl w-full max-w-lg">
                ...
                <div className="p-6 space-y-4">
                    <div className="relative">
                        ...
                        <select className="w-full border border-gray-300 rounded-lg px-3 py-3 focus:outline-none focus:ring-2 focus:ring-green-500">
                            <option>PT. BANK MANDIRI / MANDIRI</option>
                            <option>PT. BANK CENTRAL ASIA / BCA</option>
                            <option>PT. BANK RAKYAT INDONESIA / BRI</option>
                        </select>
                    </div>
                    <div className="relative border border-green-500 rounded-lg flex items-center p-1">
                        <label className="text-xs text-green-500 bg-white px-1 absolute -top-2 left-3">Nomor Rekening</label>
                        <input type="text" placeholder="" className="w-full px-2 py-2 border-0 focus:outline-none focus:ring-0" />
                        <button className="text-green-600 font-semibold px-4 text-sm hover:text-green-700">Cek Nama Pemilik</button>
                    </div>
                </div>
                <div className="p-6 bg-gray-50 rounded-b-lg">
                    <div className="flex items-start gap-3 text-sm text-gray-500 mb-4">
                        <InformationCircleIcon className="w-5 h-5 flex-shrink-0 mt-0.5" />
                        <span>Dengan klik tombol di bawah, kamu menyetujui <a href="#" className="text-green-600 font-semibold">Syarat & Ketentuan</a> serta <a href="#" className="text-green-600 font-semibold">Kebijakan Privasi</a> untuk menambahkan rekening.</span>
                    </div>
