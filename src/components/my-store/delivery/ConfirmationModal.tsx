...
const ConfirmationModal: FC<{ isOpen: boolean; onConfirm: () => void; }> = ({ isOpen, onConfirm }) => {
            ...
            <div className="bg-white p-8 rounded-[15px] shadow-xl w-full max-w-md mx-4 flex gap-4 items-start">
                ...
                <div>
                    ...
                    <div className="flex justify-end space-x-4">
                        <Link href={'/my-store'}>
                            <button className="bg-white h-[40px] text-[#4A4459] text-[15px] font-[500] border-[#79747E] border py-2 px-6  hover:bg-gray-300 transition-colors">
                                Tidak
                            </button>
                        </Link>
